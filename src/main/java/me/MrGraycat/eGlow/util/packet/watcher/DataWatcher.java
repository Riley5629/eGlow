...
public class DataWatcher {
	...
	public Object toNMS() throws Exception {
		...
		for (DataWatcherItem item : this.dataValues.values()) {
			...
			nms.dataWatcherRegister.invoke(nmsWatcher, position, item.value);
		}
		return nmsWatcher;
	}
	...
	public static DataWatcher fromNMS(Object nmsWatcher) throws Exception{
		...
		if (NMSHook.nms.isIs1_19_3OrAbove()) {
			items = new ArrayList<>(((Int2ObjectMap) NMSHook.nms.dataWatcherItemsField.get(nmsWatcher)).values());
		} else {
